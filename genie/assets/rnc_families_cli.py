...
from genie.assets.rnc_families import CODE_CLUSTER_GAP, analyze_rnc_families


def main() -> int:
    parser = argparse.ArgumentParser(description=__doc__)
    parser.add_argument("rom", nargs="?", type=Path, default=ROOT / "rom/Disneys_Aladdin_U_p1.bin")
