...
return function(options)
    ...
    local breakpoint_resource_context = os.getenv("OPENALADDIN_BREAKPOINT_RESOURCE_CONTEXT") == "1"
    ...
    for item in breakpoint_list:gmatch("[^,]+") do
        ...
        if address then
            ...
            if breakpoint_registers then
                ...
                elseif breakpoint_resource_context then
                    action = "printf \"OPENALADDIN_BREAK_RESOURCE PC=%08X FRAME=%08X D0=%08X D1=%08X D2=%08X D3=%08X D4=%08X D5=%08X D6=%08X D7=%08X A0=%08X A1=%08X A2=%08X A3=%08X A4=%08X A5=%08X A6=%08X STATE=%02X STATUS=%02X ERROR=%02X CURSOR=%08X DATA=%08X TABLE=%04X PENDING=%02X F003=%02X F005=%02X F0F1=%02X F155=%02X F57D=%02X F57E=%02X F57F=%02X\\n\",pc,frame,d0,d1,d2,d3,d4,d5,d6,d7,a0,a1,a2,a3,a4,a5,a6,:maincpu.b@$FF7E26,:maincpu.b@$FF7E22,:maincpu.b@$FF7E23,:maincpu.d@$FFF572,:maincpu.d@$FFF576,:maincpu.w@$FFF57A,:maincpu.b@$FFF57C,:maincpu.b@$FFF003,:maincpu.b@$FFF005,:maincpu.b@$FFF0F1,:maincpu.b@$FFF155,:maincpu.b@$FFF57D,:maincpu.b@$FFF57E,:maincpu.b@$FFF57F ; g"
                elseif breakpoint_row_context then
                    action = "printf \"OPENALADDIN_BREAK_ROW PC=%08X FRAME=%08X D0=%08X D1=%08X D2=%08X D3=%08X D4=%08X D5=%08X D6=%08X D7=%08X A0=%08X A1=%08X A2=%08X A3=%08X A4=%08X A5=%08X A6=%08X ROWWORD=%04X ROWINDEX=%04X INTERACTION=%02X HANDLER=%08X F003=%02X F57D=%02X F7E49=%02X F0D8=%02X A1TYPE=%02X A1BYTE1=%02X A1BYTE8=%02X A1X=%04X A1FLAGS=%02X\\n\",pc,frame,d0,d1,d2,d3,d4,d5,d6,d7,a0,a1,a2,a3,a4,a5,a6,:maincpu.w@(a0-2),d2&0xffff,d3&0xff,a4,:maincpu.b@$FFF003,:maincpu.b@$FFF57D,:maincpu.b@$FF7E49,:maincpu.b@$FFF0D8,:maincpu.b@a1,:maincpu.b@(a1+1),:maincpu.b@(a1+8),:maincpu.w@(a1+2),:maincpu.b@(a1+0x3C) ; g"
                else
