...
local core = dofile(root .. "/re/mame/core.lua")
...
local capture_streams = dofile(root .. "/re/mame/capture.lua")({
    core = core,
    trace_dir = trace_dir,
...
local vdp = dofile(root .. "/re/mame/vdp.lua")({
    core = core,
    capture = capture_vdp,
...
local input = dofile(root .. "/re/mame/input.lua")({
    core = core,
    root = root,
...
local watches = dofile(root .. "/re/mame/watches.lua")({
    core = core,
    space = space,
    cpu = cpu,
    symbol = symbol,
...
local actors = dofile(root .. "/re/mame/actors.lua")({
    space = space,
    symbol = symbol,
    read_u16 = read_u16,
    actor_table_base = actor_table_base,
