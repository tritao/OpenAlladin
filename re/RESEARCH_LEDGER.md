...
| `20260830-audio-command-wrapper-family-static-v1` | recorded-static-disassembly | Promoted the exact fixed-command audio wrapper family at 0x001E5908-0x001E5A23 plus the 0x001E58C2 command-05 wrapper, including the protected indexed Z80-result reader at 0x001E59F2 |
...
| `20260830-player-transition-flag-response-helper-static-v1` | recorded-static-disassembly | Named the exact provisional 24-byte player transition-response setter at 0x001ADA98-0x001ADAAF, which installs 0x00121C62 and clears the player animation timer/gate while leaving direct reachability unresolved |
