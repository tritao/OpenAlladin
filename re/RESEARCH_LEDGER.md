...
| `20260829-level-entry-animation-static-decompilation-v1` | recorded-static-decompilation | Direct Level-entry Type-0x84/0x42/0x54/0x7C/0x7D animation roots range-bounded with explicit shared handoffs and child-state boundaries |
...
| `20260829-type84-unreferenced-response-family-static-v1` | recorded-static-decompilation | Provisional exact ownership for the Type-0x84 0x0F22 response template at 0x001B8304, its 90-byte movement prefix at 0x00121412-0x0012146B, and its 38-byte animation loop at 0x00125D58-0x00125D7D; runtime reachability remains unresolved |
...
| `20260829-type7c-type7d-level-event-movement-static-v1` | recorded-static-decompilation | Promoted the contiguous Type-0x7C/Type-0x7D level-event MovementVM body at 0x00121180-0x0012120D as a ten-byte prelude plus a 132-byte shared owner, with the Type-0x7D pointer at 0x001211C4 recorded as an alias entry |
...
| `20260830-unindexed-movement-stream-bands-static-v1` | recorded-static-disassembly | Promoted five exact decoder-bounded MovementVM ownership bands, including the Type-0x5E/0x84 pair bank at 0x0011FAA8-0x0011FD17 and the paired-spawn AnchorResponse body at 0x001B69A6-0x001B69FF; decoded callback evidence now identifies the 0x0011FAA8 anchor-response grid, the 0x001210FE Flag-20 terrain response, the 0x001212C0 interaction-anchor bank, and the 0x001213E2 Type-0x8D wall-response child prefix while preserving provisional reachability |
