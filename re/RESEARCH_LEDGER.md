...
| `20260830-rnc-title-boundary-correction-static-v1` | tooling-validation | Corrected the title RNC payload to include its manifest-confirmed final byte at 0x001434C3 and removed the false alignment-padding owner that split the payload before the next RNC header at 0x001434C4 |
