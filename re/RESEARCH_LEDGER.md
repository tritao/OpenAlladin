...
| `20260829-type84-unreferenced-response-family-static-v1` | recorded-static-decompilation | Provisional exact ownership for the Type-0x84 0x0F22 wall-response template at 0x001B8304, its 90-byte movement prefix at 0x00121412-0x0012146B, and its 38-byte animation loop at 0x00125D58-0x00125D7D; the movement prefix spawns the Type-0x8D wall-response template and runtime reachability remains unresolved |
...
| `20260830-unindexed-movement-stream-bands-static-v1` | recorded-static-disassembly | Promoted five exact decoder-bounded MovementVM ownership bands, including the decompiled Type-0x5E/0x84 pair bank at 0x0011FAA8-0x0011FD17 and the paired-spawn AnchorResponse body at 0x001B69A6-0x001B69FF; decoded callback evidence now identifies the 0x0011FAA8 anchor-response grid, the 0x001210FE Flag-20 terrain response, the 0x001212C0 interaction-anchor bank, and the 0x001213E2 Type-0x8D wall-response child prefix while preserving provisional reachability for the unresolved bands |
