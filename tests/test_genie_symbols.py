...
def test_guard_and_handhold_numeric_identities_promote_to_semantic_names_with_aliases():
    ...
    assert {"PLAYER_COLLISION_STAGED_RESPONSE", "PLAYER_COLLISION_FOLLOWUP_RESPONSE"} <= mapping_names
...
def test_level_event_movement_names_promote_roles_and_preserve_numeric_aliases():
    ...
    expected = {
        ...
        0x001209BE: ("ACTOR_MOVE_PLAYER_COLLISION_FOLLOWUP_RESPONSE", "ACTOR_MOVE_TYPE7F_PLAYER_COLLISION_RESPONSE"),
        0x00120B2C: ("ACTOR_MOVE_INTERACTION_RESPONSE_CLEANUP_HANDOFF", "ACTOR_MOVE_TYPE2F_INTERACTION_STATE87_TRANSITION"),
        ...
        0x001215E0: ("ACTOR_MOVE_PLAYER_COLLISION_STAGED_RESPONSE", "ACTOR_MOVE_TYPE29_PLAYER_COLLISION_RESPONSE"),
        0x00121C30: ("ACTOR_ANIM_PLAYER_COLLISION_STAGED_RESPONSE", "ACTOR_ANIM_TYPE29_PLAYER_COLLISION_RESPONSE"),
...
def test_shared_interaction_names_promote_roles_and_preserve_numeric_aliases():
    ...
    expected = {
        ...
        0x00122DD8: ("ACTOR_ANIM_INTERACTION_RESPONSE_STANDARD", "ACTOR_ANIM_TYPE84_TYPE2D_INTERACTION_RESPONSE"),
        0x001B792C: ("ACTOR_TEMPLATE_INTERACTION_RESPONSE_STANDARD", "ACTOR_TEMPLATE_TYPE_2D_INTERACTION_RESPONSE"),
        0x00123A68: ("ACTOR_ANIM_INTERACTION_RESPONSE_CYCLE", "ACTOR_ANIM_TYPE2F_INTERACTION_LOOP"),
        ...
        0x001B7BD4: ("ACTOR_TEMPLATE_INTERACTION_RESPONSE_CYCLE", "ACTOR_TEMPLATE_TYPE_2F_INTERACTION"),
        0x001B7BFC: ("ACTOR_TEMPLATE_INTERACTION_RESPONSE_CYCLE_CHILD", "ACTOR_TEMPLATE_TYPE_2F_TYPE10_CHILD"),
    ...
    assert {
        ...
        "INTERACTION_RESPONSE_STANDARD",
        "INTERACTION_SHARED",
        "INTERACTION_CHILD_SPAWN",
        "INTERACTION_TERMINAL_RESPONSE",
        "INTERACTION_RESPONSE_CYCLE",
        "LEVEL_ENTRY_SHARED",
        "INTERACTION_SHARED_BASE",
        "INTERACTION_POSITION_VARIANTS",
    } <= mapping_names
    mappings_by_name = {mapping.name: mapping for mapping in mappings}
    assert {0x00120ACC, 0x00123A68, 0x001B7BD4, 0x001B7BFC} <= set(mappings_by_name["INTERACTION_RESPONSE_CYCLE"].symbol_addresses)
...
def test_upper_and_shared_presentation_names_preserve_numeric_aliases():
    ...
    expected = {
        ...
        0x0012340C: ("ACTOR_ANIM_UPPER_INTERACTION_RESPONSE", "ACTOR_ANIM_TYPE1D_INTERACTION_RESPONSE"),
        0x0012341E: ("ACTOR_ANIM_UPPER_INTERACTION_Y_PROXIMITY_ENTRY", "ACTOR_ANIM_TYPE1D_Y_PROXIMITY_ENTRY"),
        0x0012342E: ("ACTOR_ANIM_UPPER_INTERACTION_STATE_GATE", "ACTOR_ANIM_TYPE1D_STATE_GATE"),
        0x00123450: ("ACTOR_ANIM_UPPER_INTERACTION_MOVEMENT_RESPONSE", "ACTOR_ANIM_TYPE1D_MOVEMENT_RESPONSE"),
        0x00123458: ("ACTOR_ANIM_UPPER_INTERACTION_MOVEMENT_LOOP", "ACTOR_ANIM_TYPE1D_MOVEMENT_LOOP"),
        0x001235AC: ("ACTOR_ANIM_UPPER_PROXIMITY_RESPONSE", "ACTOR_ANIM_TYPE_21_PROXIMITY"),
...
def test_actor_vm_orphan_objects_have_behavior_names_and_legacy_aliases():
    expected = {
        0x001203E8: ("ACTOR_MOVE_DRIFT_PLUS2_PLUS1_LOOP", "ACTOR_MOVE_UNREFERENCED_SELF_LOOP_1203E8"),
            0x001B7990: ("ACTOR_TEMPLATE_UNREFERENCED_RESOURCE10", "ACTOR_TEMPLATE_TYPE84_RESOURCE10_NO_DEFAULT_VM"),
            0x001B7A58: ("ACTOR_TEMPLATE_UNREFERENCED_EMPTY_INIT", "ACTOR_TEMPLATE_TYPE84_EMPTY_INIT_40001400"),
    }
    symbols = SymbolStore()
    for address, (name, legacy) in expected.items():
        symbol = symbols.at(address, include_ranges=False)
...
def test_remaining_interaction_template_roles_preserve_numeric_aliases():
    ...
    expected = {
        ...
        0x001B7A30: ("ACTOR_TEMPLATE_PROXIMITY_BOUNCE_TRIGGER", "ACTOR_TEMPLATE_TYPE01"),
        ...
        0x001B7DC8: ("ACTOR_TEMPLATE_LEVEL08_EXIT_PRESENTATION", "ACTOR_TEMPLATE_TYPE_60_LEVEL08_EXIT"),
        0x001B7FA8: ("ACTOR_TEMPLATE_LEVEL09_SPAWN_BASE", "ACTOR_TEMPLATE_TYPE_50_LEVEL09_SPAWN_BASE"),
        0x001B7BE8: ("ACTOR_TEMPLATE_LEVEL12_TERMINAL_EVENT", "ACTOR_TEMPLATE_TYPE_2F_LEVEL12_EVENT"),
        0x001B80D4: ("ACTOR_TEMPLATE_LEVEL09_ENTRY", "ACTOR_TEMPLATE_TYPE_52_LEVEL09"),
...
def test_decoded_stream_and_palette_roles_preserve_numeric_aliases():
    ...
    expected = {
        ...
        0x001222C2: ("ACTOR_ANIM_INTERACTION_PAIR_RESPONSE", "ACTOR_ANIM_TYPE12_TYPE4D_RESPONSE"),
        0x00122D54: ("ACTOR_ANIM_INTERACTION_POSITION_RESPONSE", "ACTOR_ANIM_TYPE55_INTERACTION"),
        ...
        0x00122D92: ("ACTOR_ANIM_PROXIMITY_BOUNCE_TRIGGER", "ACTOR_ANIM_TYPE01"),
        ...
        0x001239A0: ("ACTOR_ANIM_COLLISION_RESPONSE_RESTORE", "ACTOR_ANIM_TYPE10_COLLISION_RESPONSE"),
        0x00124A2E: ("ACTOR_ANIM_PRESENTATION_RESPONSE_VARIANT_A", "ACTOR_ANIM_TYPE8B_PRESENTATION_F5"),
        0x00124A6C: ("ACTOR_ANIM_PRESENTATION_RESPONSE_VARIANT_B", "ACTOR_ANIM_TYPE8B_PRESENTATION_F6"),
        0x00124AAA: ("ACTOR_ANIM_PRESENTATION_RESPONSE_VARIANT_C", "ACTOR_ANIM_TYPE8B_PRESENTATION_F7"),
        0x00124AE0: ("ACTOR_ANIM_PRESENTATION_RESPONSE_VARIANT_D", "ACTOR_ANIM_TYPE8B_PRESENTATION_F8"),
        0x00124B94: ("ACTOR_ANIM_LEVEL09_RESPONSE_ENTRY", "ACTOR_ANIM_TYPE50_LEVEL09_RESPONSE_ENTRY"),
        ...
        0x00129152: ("INTERACTION_GUARD_RESPONSE_PALETTE_SOURCE", "INTERACTION_TYPE13_PALETTE_SOURCE"),
        0x001295D2: ("INTERACTION_PRESENTATION_RESPONSE_PALETTE_SOURCE", "INTERACTION_TYPE12_PALETTE_SOURCE"),
...
def test_wall_oscillation_frames_have_semantic_names_and_legacy_aliases():
    symbols = SymbolStore()
    expected = {
        0x001F3DEE: ("ACTOR_FRAME_WALL_OSCILLATION_PRIMARY", "ACTOR_FRAME_TYPE_34_WALL"),
        0x001F3E30: ("ACTOR_FRAME_WALL_OSCILLATION_VARIANT_A", "ACTOR_FRAME_TYPE_34_WALL_VARIANT_1"),
        0x001F3E72: ("ACTOR_FRAME_WALL_OSCILLATION_VARIANT_B", "ACTOR_FRAME_TYPE_34_WALL_VARIANT_2"),
        0x001F3E9C: ("ACTOR_FRAME_WALL_OSCILLATION_VARIANT_C", "ACTOR_FRAME_TYPE_34_WALL_VARIANT_3"),
    }
    for address, (name, alias) in expected.items():
        symbol = symbols.at(address, include_ranges=False)
        assert symbol is not None
    ...
    mappings = {mapping.name: mapping for mapping in load_entity_mappings()}
    assert set((0x00122D92, 0x001B7A30, 0x001AFD84)) <= set(
        mappings["PROXIMITY_BOUNCE_TRIGGER"].symbol_addresses
    )
...
def test_remaining_numeric_stream_and_template_names_promote_evidence_backed_roles():
    symbols = SymbolStore()
    expected = {
        0x00120A00: ("ACTOR_MOVE_INTERACTION_RANDOM_CHILD_RESPONSE", "ACTOR_MOVE_TYPE84_TYPE0F_CHILD_RESPONSE"),
        0x00120948: ("ACTOR_MOVE_INTERACTION_SHARED_RESPONSE", "ACTOR_MOVE_RUNTIME_TYPE6E_73_SHARED_RESPONSE"),
        0x00120D7A: ("ACTOR_MOVE_INTERACTION_VARIANT_BASE", "ACTOR_MOVE_TYPE52_INTERACTION_BASE"),
        0x001213E2: ("ACTOR_MOVE_WALL_RESPONSE_CHILD_SPAWN_PREFIX", "ACTOR_MOVE_TYPE8D_WALL_RESPONSE_CHILD_SPAWN_PREFIX"),
        0x00123DEA: ("ACTOR_ANIM_INTERACTION_SHARED_BASE_DEFAULT", "ACTOR_ANIM_TYPE6E_73_BASE_DEFAULT"),
        0x00122DF2: ("ACTOR_ANIM_INTERACTION_FRAME_CYCLE", "ACTOR_ANIM_TYPE03_INTERACTION"),
        0x00124F32: ("ACTOR_ANIM_INTERACTION_CHILD_SPAWN_PREFIX", "ACTOR_ANIM_TYPE31_CHILD_SPAWN_PREFIX"),
        0x00124F96: ("ACTOR_ANIM_INTERACTION_CHILD_A", "ACTOR_ANIM_TYPE31_F5_CHILD_A"),
        0x00125028: ("ACTOR_ANIM_INTERACTION_CHILD_B", "ACTOR_ANIM_TYPE31_F5_CHILD_B"),
        0x001253E8: ("ACTOR_ANIM_LEVEL09_ENTRY", "ACTOR_ANIM_TYPE52_LEVEL09_ENTRY"),
        0x001253FA: ("ACTOR_ANIM_LEVEL09_RESPONSE_CLEAR", "ACTOR_ANIM_TYPE52_LEVEL09_RESPONSE_PREFIX"),
        0x0012548E: ("ACTOR_ANIM_INTERACTION_VARIANT_BASE", "ACTOR_ANIM_TYPE52_INTERACTION_BASE"),
        0x00125548: ("ACTOR_ANIM_INTERACTION_CALLBACK_PRESENTATION_FRAME_13B2", "ACTOR_ANIM_TYPE52_SELECTOR_CB"),
        0x0012557A: ("ACTOR_ANIM_INTERACTION_DIFFICULTY_GATED_RESPONSE", "ACTOR_ANIM_TYPE52_SELECTOR_5B"),
        0x00125634: ("ACTOR_ANIM_INTERACTION_DIFFICULTY_GATED_RESPONSE_ALTERNATE", "ACTOR_ANIM_TYPE52_SELECTOR_5D"),
        0x001EF4D4: ("ACTOR_FRAME_CHOPPER_WALL_RESPONSE", "ACTOR_FRAME_TYPE_8D_WALL_RESPONSE"),
        0x001B7AD0: ("ACTOR_TEMPLATE_INTERACTION_EXTENDED_RESPONSE_CHILD", "ACTOR_TEMPLATE_TYPE_7F_TYPE36_CHILD"),
        0x001B7E40: ("ACTOR_TEMPLATE_COLLISION_REINITIALIZATION_RESPONSE", "ACTOR_TEMPLATE_TYPE_84"),
        0x001B7B34: ("ACTOR_TEMPLATE_VERTICAL_BOB_INTERACTION", "ACTOR_TEMPLATE_TYPE_06"),
        0x001B7B5C: ("ACTOR_TEMPLATE_PLAYER_COLLISION_MOVING_CHILD", "ACTOR_TEMPLATE_TYPE_84_TYPE3E_3F_COLLISION_CHILD"),
        0x001B7990: ("ACTOR_TEMPLATE_UNREFERENCED_RESOURCE10", "ACTOR_TEMPLATE_TYPE84_RESOURCE10_NO_DEFAULT_VM"),
        0x001B79A4: ("ACTOR_TEMPLATE_ACTOR_COLLISION_RESPONSE_CHILD", "ACTOR_TEMPLATE_TYPE84_COLLISION_CHILD"),
        0x001B7A58: ("ACTOR_TEMPLATE_UNREFERENCED_EMPTY_INIT", "ACTOR_TEMPLATE_TYPE84_EMPTY_INIT_40001400"),
        0x001B7FBC: ("ACTOR_TEMPLATE_COMPACT_INTERACTION_RESPONSE", "ACTOR_TEMPLATE_TYPE_64"),
        0x001B7A6C: ("ACTOR_TEMPLATE_INTERACTION_FRAME_CYCLE", "ACTOR_TEMPLATE_TYPE_03_INTERACTION"),
    }
    for address, (name, alias) in expected.items():
        symbol = symbols.at(address, include_ranges=False)
        assert symbol is not None
    ...
    assert validate_entity_mappings(mappings.values()) == []
    assert {
        "INTERACTION_FRAME_CYCLE",
        "INTERACTION_VARIANT_BASE",
        "INTERACTION_EXTENDED_RESPONSE",
        "VERTICAL_BOB_INTERACTION",
        "COLLISION_REINITIALIZATION_RESPONSE",
        "ACTOR_COLLISION_RESPONSE_CHILD",
    } <= mappings.keys()
    assert 0x001253E8 in mappings["LEVEL09_ENTRY"].symbol_addresses
