...
def test_canonical_actor_animation_family_has_exact_non_overlapping_ranges():
    ...
    expected = {
        ...
        0x00124BDC: (0x00124C17, "ACTOR_ANIM_SCENE_SETUP_FIXED"),
...
def test_upper_collision_response_animation_family_is_exact():
    ...
    expected = {
        ...
        0x0012340C: (0x001234BD, "ACTOR_ANIM_UPPER_INTERACTION_RESPONSE"),
    ...
    aliases = {
        0x0012341E: ("ACTOR_ANIM_UPPER_INTERACTION_Y_PROXIMITY_ENTRY", 18),
        0x0012342E: ("ACTOR_ANIM_UPPER_INTERACTION_STATE_GATE", 34),
        0x00123450: ("ACTOR_ANIM_UPPER_INTERACTION_MOVEMENT_RESPONSE", 68),
        0x00123458: ("ACTOR_ANIM_UPPER_INTERACTION_MOVEMENT_LOOP", 76),
...
def test_player_terrain_bounce_state_helper_is_exact():
    symbols = SymbolStore()
    helper = symbols.at(0x001ADAB0, include_ranges=False)
    assert helper is not None
    assert helper.name == "Player_AdvanceTerrainBounceState"
    assert helper.end == 0x001ADB21
    assert helper.size == 114
    assert helper.confidence == "decompiled"

    rom = (Path(__file__).resolve().parents[1] / "rom/Disneys_Aladdin_U_p1.bin").read_bytes()
    assert rom[0x001ADAB0:0x001ADB22] == bytes.fromhex(
        "4A3900FFF0BE670A4A3900FFF0C0670000684A3900FFF0D06600005E4A39"
        "00FFF0D7660000544A3900FFF0DB6600004A303900FF7E5A064000780C40"
        "0800640633C000FF7E5A0C3900FF00FFF0EB6706523900FFF0EB0C390028"
        "00FFF0EB661823FC00121AD800FF7E60423900FF7E774E75"
    )
...
def test_actor_type04_collision_animation_entry_is_exact():
    ...
    assert nested.name == "ACTOR_ANIM_SCENE_SETUP_COLLISION_CHILD_SPAWN"
...
def test_orphaned_code_islands_have_complete_owners_and_decoded_rts_bodies():
    ...
    expected = {
        ...
        0x001B1CFE: ("Orphaned_RtsStub_001B1CFE", 2, "4E75", "decompiled"),
            0x001B3C5E: ("Menu_RunOptionsFrameLoopPrelude", 6, "EB2C6100FEE8", "decompiled"),
            0x001B3C7C: ("Menu_RunOptionsPresentationContinuation", 316, None, "decompiled"),
