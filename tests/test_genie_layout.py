...
def test_unindexed_movement_stream_bands_are_exact_with_evidence_confidence():
    ...
    expected = [
        ...
        (0x001210FE, 0x0012117F, "ACTOR_MOVE_FLAG20_TERRAIN_RESPONSE_001210FE", 0x82, "provisional"),
        (0x001212C0, 0x001212FF, "ACTOR_MOVE_INTERACTION_ANCHOR_RESPONSE_BANK_001212C0", 0x40, "provisional"),
        (0x001213E2, 0x00121411, "ACTOR_MOVE_TYPE8D_WALL_RESPONSE_CHILD_SPAWN_PREFIX", 0x30, "provisional"),
