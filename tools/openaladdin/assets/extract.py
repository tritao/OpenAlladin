...
from openaladdin.assets.chopper import extract_chopper
from openaladdin.assets.levels import extract_levels, find_level_table, read_level_table
from openaladdin.assets.rnc import extract_rnc_corpus, is_rnc, parse_header
from openaladdin.assets.rnc_assets import classify_rnc_corpus
from openaladdin.assets.rnc_families import analyze_rnc_families
from openaladdin.assets.rnc_loaders import analyze_rnc_loaders
from openaladdin.assets.rnc_runtime import analyze_rnc_runtime
from openaladdin.assets.rnc_refs import scan_rnc_references, write_rnc_references
from openaladdin.assets.scene_resources import validate_scene_resources
from openaladdin.assets.scene_transitions import extract_scene_transitions
...
def default_rom() -> Path:
    configured = ROOT / "rom/Disneys_Aladdin_U_p1.bin"
