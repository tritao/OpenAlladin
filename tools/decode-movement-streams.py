...
DEFAULT_ENTRIES = {
    ...
    "ACTOR_MOVE_STATE_11F728": 0x0011F728,
    "ACTOR_MOVE_STATE_120360": 0x00120360,
    "ACTOR_MOVE_STATE_1203C0": 0x001203C0,
    "ACTOR_MOVE_STATE_120432": 0x00120432,
    "ACTOR_MOVE_STATE_12046C": 0x0012046C,
    "ACTOR_MOVE_STATE_1204E2": 0x001204E2,
    "ACTOR_MOVE_STATE_120F76": 0x00120F76,
...
def main() -> int:
    ...
    parser.add_argument(
        ...
        nargs="?",
        type=Path,
        default=ROOT / "Disneys_Aladdin_U_p1.bin",
    )
    parser.add_argument(
        "--entry",
        action="append",
